...
class VideoService:
    ...
    def _add_video_face_record(self, face_id, frame_idx, face_idx, bbox, attributes, face_upload):
    ...
    def _save_video_faces(self):
        ...
        for record in face_records:
            ...
            face_upload = storage.upload_image(face_buffer)
            self._add_video_face_record(face_id, frame_idx, face_idx, bbox, attributes, face_upload)
