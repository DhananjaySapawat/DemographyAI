...
def extract_face_coordinates(image, face_detector=None):
...
def write_face_labels(frame, x1, y1, x2, y2, attributes):
    ...
    age_v1 = attributes["age_v1"]["label"] if attributes["age_v1"] else "N/A"
    gender = attributes["gender"]["label"] if attributes["gender"] else "N/A"
    ethnicity = attributes["ethnicity"]["label"] if attributes["ethnicity"] else "N/A"
    emotion = attributes["emotion"]["label"] if attributes["emotion"] else "N/A"
